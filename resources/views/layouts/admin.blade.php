...
<body>
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
            <li class="dropdown-header">
              ...
              <span>{{ ucwords(str_replace('-', ' ', auth()->user()->role)) }}</span>
            </li>
            <li>
  ...
  <script type="text/javascript" src="https://www.bugherd.com/sidebarv2.js?apikey=041jmgv9vibpvt5bhdoymq" async="true"></script>
