...
<div class="col-lg-12">
    <div class="card">
        <div class="card-body">
            <h5 class="card-title">New Category File</h5>

            <form action="{{ route('categories.files.store', $category->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group mb-3" id="fileUploadSection" style="display: none;">
                    <label for="file_path">Upload File (PDF, PPT, PPTX or Image)</label>
                ...
                <!-- Action Buttons -->
                <a href="{{ route('categories.files.index', $category->id) }}" class="btn btn-warning">Back</a>
