            ...
            @foreach($sliders as $index => $slider)
                <div class="carousel-item {{ $index == 0 ? 'active' : '' }}">
                    ...
                    <div class="carousel-caption d-md-block">
                        <h5 class="animate__animated animate__fadeInLeft animate__delay-.1s">{{ $slider->title }}</h5>
                        <hr>
                        <p class="animate__animated animate__fadeInLeft animate__delay-1s">{{ $slider->sub_title }}</p>
                        @if($slider->btn_link)
  ...
  <div class="img_container">
      <a href="#">
          <div class="image col3">
              <img src="{{asset('')}}front/images/pixcel5.png" alt="image">
          </div>
      </a>
      ...
      <a href="#">
          <div class="image col3">
              <img src="{{asset('')}}front/images/pixelcut6.png" alt="image">
          </div>
      </a>
  </div>
</section>
          ...
          <a class="d-block" href="#">
              <div class="coll">
                  <div class="feature_img">
                      <div class="img">
                          <img src="{{asset('')}}front/images/pixelcut-export7.png" alt="img">
                      </div>
                      <div class="txt">
